...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void setupCameraParameters() {
        ...
        mCameraWrapper.mCamera.setParameters(parameters); // 必须设置,否则有些手机扫码对焦错误
//        Log.d("CameraPrevice", String.format("==%dx%d", parameters.getPreviewSize().width, parameters.getPreviewSize().height));
