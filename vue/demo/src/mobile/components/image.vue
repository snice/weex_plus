  ...
  <scroller>
    ...
    <panel title="resize" type="primary">
      <panel title="resize=stretch(default) 600 x 200 ">
        <image placeHolder="mipmap://ic_launcher" class="img" style=" width: 600px; height: 200px;border-style: solid;border-width: 1px;border-color: #333;" :src="img" resize="stretch"></image>
      </panel>
